  ...
  return (
    <>
      <motion.div
        ...
        className="flex flex-col justify-between overflow-hidden mt-[96px] mb-24 max-[768px]:max-w-[340px] lg:max-w-[85%] bg-[#0F1123] rounded-lg mx-auto px-14 pt-[18px] max-[768px]:px-7 pb-8"
      >

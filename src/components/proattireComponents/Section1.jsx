  ...
  return (
    <>
      <motion.div
        ...
        className="flex flex-col justify-between mt-[96px] max-[768px]:max-w-[360px] lg:max-w-[85%] lg:h-[260px] h-[160px] bg-[#0F1123] rounded-lg mx-auto px-14 pt-[18px] max-[768px]:px-7 pb-8"
      >

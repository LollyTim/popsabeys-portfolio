  ...
  return (
    <>
      <motion.div
        ...
        className="flex flex-col justify-between mt-[96px] py-10 lg:max-w-[85%] max-w-[360px] h-[260px] max-[768px]:h-[160px] bg-[#0F1123] rounded-lg mx-auto px-14 max-[768px]:px-7 max-[768px]:pb-8"
      >
      ...
      <motion.div
        ...
        className=" py-7 mx-auto flex max-[768px]:max-w-[360px] max-w-[85%] mt-[72px]"
      >
        <img src="\images\Rectangle 44 (3).png" alt="" className="w-full" />
      </motion.div>
